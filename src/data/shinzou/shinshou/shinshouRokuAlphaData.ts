...
import shinshouChpt1 from "../../../traducciones/shinzou/shinshou/chpt_1.txt"
...
const shinshouRokuAlphaChapterLargeBreakpoints: ChapterBreakpoints[] = [
    ...
    { breakpoint: 21, opacity: 0.6, imageSrc: shinshouABG3 },
...
const shinshouRokuAlphaChapterSmallBreakpoints: ChapterBreakpoints[] = [
    ...
    { breakpoint: 17, opacity: 0.6, imageSrc: shinshouABG4Small },
...
export const shinshouRokuAlphaData: ChapterPageProps = {
    ...
    commentsSection: { section: "shinzou/shinshou/chpt1", commentsBG: shinzouCommentBG }
}
