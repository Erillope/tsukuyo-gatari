...
import shinshouChpt15 from "../../../traducciones/shinzou/shinshou/chpt_15.txt"
...
export const shinshouRokuVData: ChapterPageProps = {
    ...
    commentsSection: { section: "shinzou/shinshou/chpt15", commentsBG: shinzouCommentBG }
}
