...
import shinshouChpt12 from "../../../traducciones/shinzou/shinshou/chpt_12.txt"
...
export const shinshouRokuTData: ChapterPageProps = {
    ...
    videoLinks: [crescent],
    commentsSection: { section: "shinzou/shinshou/chpt12", commentsBG: shinzouCommentBG }
}
