...
import shinshouChpt14 from "../../../traducciones/shinzou/shinshou/chpt_14.txt"
...
export const shinshouRokuIData: ChapterPageProps = {
    ...
    commentsSection: { section: "shinzou/shinshou/chpt14", commentsBG: shinzouCommentBG }
}
