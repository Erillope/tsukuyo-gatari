...
const shinshouRokuDeltaChapterLargeBreakpoints: ChapterBreakpoints[] = [
    ...
    { breakpoint: 15, opacity: 0.65, imageSrc: shinshouRokuDelta },
    { breakpoint: 25, opacity: 0.6, imageSrc: shinshouDeltaBG2 },
]
...
const shinshouRokuDeltaChapterSmallBreakpoints: ChapterBreakpoints[] = [
    ...
    { breakpoint: 15, opacity: 0.7, imageSrc: shinshouDeltaBG5Small },
    { breakpoint: 18, opacity: 0.6, imageSrc: shinshouDeltaBG6 },
    { breakpoint: 23, opacity: 0.6, imageSrc: shinshouDeltaBG2Small },
]
